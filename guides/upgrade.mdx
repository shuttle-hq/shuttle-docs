...
1. Check the [release page](https://github.com/shuttle-hq/shuttle/releases) for any considerations regarding breaking changes in the new release.

2. Upgrade your `cargo-shuttle` CLI with one of the options below:
