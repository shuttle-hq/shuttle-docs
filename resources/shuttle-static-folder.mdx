...
## Usage
Add `shuttle-static-folder` to the dependencies for your service by editing the `cargo.toml` file in the crate root. Then, add a parameter to the return values of the main function, annotated as follows:
