...
Before starting to use Shuttle services it is important to get to know its different commands.
To access the different shuttle commands you have to type in the following command:
```
cargo shuttle help
```
