---
title: "Integrate AWS RDS with Shuttle"
description: "Seamlessly connect AWS RDS with your Rust applications on Shuttle. Our documentation shows you the steps to ensure robust database management."
icon: "aws"
---
...
Shuttle makes sure that any data stored in your provisioned database is stored permanently and will persist if you redeploy your server via `shuttle deploy`, as well as if you restart your service via `shuttle project restart`.
