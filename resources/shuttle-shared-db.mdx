...
| Postgres | `opendal-postgres` | `opendal::Operator` | An OpenDAL Operator key-value storage interface |
| Postgres | `opendal-postgres` | `shuttle_shared_db::SerdeJsonOperator` | A wrapper over Operator with interface for serde types |
