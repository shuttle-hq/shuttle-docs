...
A shared database is in the same cluster as other user's databases, but it is not be accessible by other users.
...
By default, you can get the connection string to the database and connect to it the way you want to.
