...
<Note>
    The OpenTelemetry exporter is required if you want to emit custom metrics and logs from your application. If you only need the default CPU, network, and memory metrics, you can skip enabling the exporter.
</Note>
...
- Disk I/O statistics
- Custom metrics from your application (requires code change to add OpenTelemetry exporter)
