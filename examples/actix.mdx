...
This section revolves around simple Actix Web examples you can get quickly started with by following these 3 steps:
1. Initialize a new Actix Web project by running the `cargo shuttle init --template actix` command
