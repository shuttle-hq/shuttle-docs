...
> make sure you are installing shuttle [via binary](../instroduction/installation).
...
[dependencies]
actix-web = "4.2.1"
shuttle-service = { version = '0.10.0', features = ["web-actix-web"] }
```
