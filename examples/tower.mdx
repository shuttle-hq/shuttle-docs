...
[![Open in Gitpod](https://gitpod.io/button/open-in-gitpod.svg)](https://gitpod.io/#https://github.com/shuttle-hq/shuttle-examples/tree/main/tower/hello-world)
...
shuttle-service = { version = "0.6.0", features = ["web-tower"] }
