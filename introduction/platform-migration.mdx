...
# Navigate between the Old and the New Platform
## Access the NEW platform

- Main website: [www.shuttle.dev](http://www.shuttle.dev)
- New Console: [console.shuttle.dev](http://console.shuttle.dev)
- New Docs: [docs.shuttle.dev](http://docs.shuttle.dev)
- Command Line: new `shuttle` command (installed  alongside the previous `cargo shuttle`)

## Access the OLD platform (for existing users)

- Main website: not accessible, redirects to [www.shuttle.dev](http://www.shuttle.dev)
- Old Console: [console.shuttle.rs](http://console.shuttle.rs)
- Old Docs: [docs.shuttle.dev](http://docs.shuttle.dev)
- Command Line (unchanged):  `cargo shuttle` as usual
