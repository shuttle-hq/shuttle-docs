...
```bash
shuttle project delete --name <name>
```
...
```bash
shuttle project restart --name <name>
shuttle project delete --name <name>
```
...
shuttle resource list --name <name>
# example for a shared postgres db
shuttle resource delete database::shared::postgres --name <name>
```
