...
<AccordionGroup>
  ...
  <Accordion title="Can I use frontend frameworks with Shuttle?">
    ...
    For details on how to use static files with shuttle, check out our docs: [Shuttle static folder](https://docs.shuttle.rs/resources/shuttle-static-folder)
  ...
  <Accordion title="Can I implement my own custom service for shuttle?">
    Absolutely! And it's quite easy. Check out this section of our docs for the steps to do so: [Custom Services](https://docs.shuttle.rs/examples/custom-service)
  </Accordion>
  <Accordion title="Can I use SeaORM with shuttle?">
    Yes, since you are able to can create a SeaORM connection from the sqlx pool Shuttle passes to you when you provision a SQL database. You can take a look at the example [here](https://github.com/shuttle-hq/shuttle/issues/179#issuecomment-1203536025).
  </Accordion>
  <Accordion title="Can I rename my shuttle project?">
    Certainly. Just create a `Shuttle.toml` file in the same folder where your `Cargo.toml` is and add `name = "your-project-name"`.  Please see "Shuttle Service Name" within the "Configuration" menu on the left for further information.
  </Accordion>
</AccordionGroup>
