...
<AccordionGroup>
  ...
  <Accordion title="What happens when I create a project?">
    The `shuttle project start` command starts a Docker container.
  ...
  <Accordion title="Can I use frontend frameworks with Shuttle?">
    Of course! When you deploy a project on Shuttle, your app becomes available at a URL of the form `${project_name}.shuttle.app`.
  ...
  <Accordion title="Can I rename my Shuttle project?">
    A project can't yet be renamed in place, but you can create a `Shuttle.toml` file to deploy it to a new name. Read more [here](/configuration/project-name).
  </Accordion>
