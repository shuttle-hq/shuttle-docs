...
<AccordionGroup>
  ...
  <Accordion title="What happens when I create a project?">
    ...
    stay up indefinitely as long as it [is active](/getting-started/idle-projects). Your project container
  ...
  <Accordion title="Which version of Rust will my project be compiled with?">
    Currently all your projects are built in a container that is pinned to rustc 1.72. It's not currently possible
