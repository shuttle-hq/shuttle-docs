...
<AccordionGroup>
  ...
  <Accordion title="What happens when I create a project?">
    The `cargo shuttle project new` command creates a Docker containers, which will
    stay up indefinitely as long as it [is active](../idle-projects). Your project container
