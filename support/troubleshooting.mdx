...
<AccordionGroup>
  ...
  <Accordion title="I get HTTP error code 600 while my project is in deployment">
    ...
    Instrumenting your application is a great way to get insight into panics/crashes. We also have [an article on using the Tracing libraries.](https://www.shuttle.dev/blog/2024/01/09/getting-started-tracing-rust)
  </Accordion>
