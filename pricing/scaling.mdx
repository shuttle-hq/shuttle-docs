...
Growth tier users can create replicas of their applications to distribute traffic and increase availability. Each replica is billed based on its instance size and vCPU usage per hour.
