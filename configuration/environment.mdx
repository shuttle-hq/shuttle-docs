...
The current Rust version is `1.81.0`, toolchain `stable-x86_64-unknown-linux-gnu`.
...
<Warning>
  Most of the limits below are due to change as we roll out paid tiers. Read more about Pricing [here](https://www.shuttle.dev/pricing).
</Warning>
