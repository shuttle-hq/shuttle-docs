...
<Info>In the free Community Tier, you can own a total of 3 project names at once. See [Pricing](https://www.shuttle.dev/pricing) for Pro tier benefits, such as more projects.</Info>
...
shuttle start --name my-project-name

# Check the deployment list of `my-project-name`
shuttle deployment list --name my-project-name
```
...
```bash
shuttle init --template axum --name my-project-name some-directory
```
